...
export default function CheckoutPage() {
    ...
    if (loading) return <p className="text-center py-10 text-muted-foreground flex justify-center items-center gap-3">Loading checkout <Spinner className="size-4" /></p>
