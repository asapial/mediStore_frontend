...
const navData: NavItem[] = [
  ...
  {
    title: "Coupons",
    url: "/dashboard/customer/coupons",
    role: "CUSTOMER",
    icon: FaTag,
    iconClass: "icon-orders",
    group: "Shopping",
  ...
  },
  {
    ...
    url: "/dashboard/customer/tracking",
    role: "CUSTOMER",
    icon: FaTruck,
    iconClass: "icon-orders",
    group: "Orders",
  ...
  {
    title: "Split Orders",
    url: "/dashboard/seller/sub-orders",
    role: "SELLER",
    icon: FaSitemap,
  ...
  {
    title: "Notifications",
    url: "/dashboard/seller/notifications",
    role: "SELLER",
    icon: FaBell,
    iconClass: "icon-alert",
    group: "Account",
