        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {items.map((banner) => (
            <a key={banner.id} href={banner.link || "/shop"}
              className="relative overflow-hidden rounded-2xl p-6 cursor-pointer group transition-transform hover:scale-[1.02] shadow-lg block"
              ...
              <div className="relative z-10 flex flex-col gap-3 h-full">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold mt-1 text-white">{banner.title}</h3>
                </div>
              ...
              {banner.imageUrl
                ...
                : <div className="absolute right-4 bottom-4 text-5xl opacity-20 group-hover:opacity-30 transition-opacity select-none pointer-events-none">{banner.icon}</div>}
